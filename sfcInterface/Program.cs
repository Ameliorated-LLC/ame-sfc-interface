...
namespace sfcInterface
{
    class Program
    {
        ...
        static void Warning(object sender, ElapsedEventArgs e)
        {
            ...
            ToastContentBuilder warning = new ToastContentBuilder();
            warning.AddText($"{parentProcess.ProcessName}.exe was prevented from running sfc {_cmdLine}.");
            warning.Show();
